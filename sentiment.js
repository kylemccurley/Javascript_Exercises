...
function sentiment(text) {
  let posWords = text.match(positiveRegex);
  let negWords = text.match(negativeRegex);
  let sentiment = (posWords.length - negWords.length);

  console.log('There are ' + posWords.length + ' positive type words in text.');
